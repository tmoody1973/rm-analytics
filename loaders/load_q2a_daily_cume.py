"""
Q2a — Daily cume backfill loader.

Target: wms.fact_daily_cume   PK (station_code, date)
Triton export cols: Station, Day, AAS, TLH, CUME, SS, TSL

CLI:   python loaders/load_q2a_daily_cume.py exports/Q2a_daily_2024-01-01_to_2026-05-20.xlsx
"""
...
TABLE = "wms.fact_daily_cume"
EXPECTED_COLS = ["Station", "Day", "AAS", "TLH", "CUME", "SS", "TSL"]

COLUMNS = ["station_code", "date", "aas", "tlh", "cume", "ss", "tsl_minutes"]
CONFLICT_COLUMNS = ["station_code", "date"]
UPDATE_COLUMNS = ["aas", "tlh", "cume", "ss", "tsl_minutes"]


def load(file_path: str) -> dict:
    """Load a Q2a daily-cume export into wms.fact_daily_cume. Returns stats."""
    start = time.time()
