"""
Q2c — Monthly cume backfill loader.

Target: wms.fact_monthly_cume   PK (station_code, month_start)
Triton export cols: Station, Month, AAS, TLH, CUME, SS, TSL

CLI:   python loaders/load_q2c_monthly_cume.py exports/Q2c_monthly_2024-01-01_to_2026-05-20.xlsx
"""
...
TABLE = "wms.fact_monthly_cume"
EXPECTED_COLS = ["Station", "Month", "AAS", "TLH", "CUME", "SS", "TSL"]

COLUMNS = ["station_code", "month_start", "aas", "tlh", "cume", "ss", "tsl_minutes"]
CONFLICT_COLUMNS = ["station_code", "month_start"]
